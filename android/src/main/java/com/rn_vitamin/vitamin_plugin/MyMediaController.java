...
import com.rn_vitamin.view.SwitchVideoTypeDialog;
...
public class MyMediaController extends MediaController {
    ...
    private TextView textViewDefinition;//时间提示
    private TextView textViewSpeed;//播放速度
    //播放速度
    private float speed = 1;
    //全屏
    private ImageView imageView_Full;

    public List<SwitchVideoModel> mUrlList = new ArrayList<>();
    ...
    //清晰度监听
    private View.OnClickListener definationListener = new View.OnClickListener() {
        public void onClick(View v) {
            showSwitchDialog();
        }
    };
    ...
    private View.OnClickListener fullScreenListener = new View.OnClickListener() {
        public void onClick(View v) {
            if(activity.getRequestedOrientation()== ActivityInfo.SCREEN_ORIENTATION_PORTRAIT){
                ...
                imageView_Full.setImageResource(R.drawable.video_shrink);
            }else{
                activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
                imageView_Full.setImageResource(R.drawable.video_enlarge);
            }
        }
    };
...
//        img_Battery = (ImageView) v.findViewById(R.id.mediacontroller_imgBattery);
        ...
        textViewSpeed = (TextView)v.findViewById(R.id.mediacontroller_speed);
        textViewSpeed.setOnClickListener(speedListener);
        textViewDefinition = (TextView)v.findViewById(R.id.mediacontroller_definition);
        textViewDefinition.setOnClickListener(definationListener);
        seekBarProgress = (SeekBar)v.findViewById(R.id.mediacontroller_seekbar);
        imageView_Full= (ImageView) v.findViewById(R.id.fullscreen);
        imageView_Full.setOnClickListener(fullScreenListener);
        //mid
...
//            }
    ...
    private void resolveTypeUI() {
        ...
        textViewSpeed.setText("播放速度：" + speed);
        videoView.setPlaySpeed(speed);
    }
            ...
            public void onItemClick(final int position) {
                ...
                if (mSourcePosition != position) {
                    if(videoView.isPlaying()){
                        videoView.pause();
                        hide();
                        final long currentPosition=videoView.getCurrentPosition();
                        videoView.setVideoPath(mUrlList.get(position).getUrl());
                        ...
                        textViewDefinition.setText(name);
