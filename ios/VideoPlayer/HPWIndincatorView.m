...
@implementation HPWIndincatorView
...
- (void)setProgress:(CGFloat)progress{
    ...
    [self.progressLabel setText:[NSString stringWithFormat:@"%@/%@",[self hmsStringWithFloat:self.currentDuration],[self hmsStringWithFloat:self.maxDuration]]];
}
